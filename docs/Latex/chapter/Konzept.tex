...
soll der Ausblick aus der DHBW in Richtung Bodensee dargestellt werden. Zusätzlich können die Schränke geöffnet und geschlossen werden und die Tafel nach oben bzw. nach unten geschoben werden.
\newparagraph
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|}
    ...
    \hline
    \multirow{2}{*}{Plane}  & https://sketchfab.com/3d-models/low-poly-  & \multirow{2}{*}{/flight-simulator/low-poly\_airplane.glb-low} \\ 
