...
\newcommand{\textKeyboradKey}[1]{\gqq{#1}}
\newcommand{\newparagraph}{\newline \newline}
...
\begin{document}
  ...
  \include{chapter/Tools}
  \include{chapter/Konzept.tex}
  \include{chapter/Realisierung.tex}
  \include{chapter/Finalproduct.tex}
  \include{chapter/Installationsanleitung.tex}
